...
public class MemberMissionRestController {
    ...
    private final MemberMissionQueryServiceImpl memberMissionQueryServiceImpl;
    ...
    public ApiResponse<MemberMissionResponseDTO.AddResultDTO> challengeMission(@RequestBody @Valid MemberMissionRequestDTO.AddDTO request){
        MemberMission memberMission = memberMissionQueryServiceImpl.challengeMission(request);
